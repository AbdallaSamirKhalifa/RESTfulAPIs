...
public class ProcessList
{
    ...
    private static extern bool EnumProcesses([MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U4)][In][Out] uint[] processIds,
        uint arraySizeBytes, out uint bytesReturned);
    ...
    /// <summary>
    /// Call this mehtod by a console application (it prints the processes information in the console)
    /// </summary>
